...
public:
    ...
    /** \brief Set the initial solution for the solver.
     *
     * \param[in] initialSolution The initial solution.
     */
    virtual void setInitialSolution(double *initialSolution) = 0;

    /** \brief Set the update history where results are recorded.
     *
     * \param[in] updateHistory the update history pointer.
     */
    void setUpdateHistory(UpdateHistory* updateHistory) { this->updateHistory = updateHistory; }
