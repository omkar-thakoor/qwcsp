...
#include "GurobiCustomCallback.h"
...
public:
  ...
  /** \brief set an initial solution for Gurobi solver */
  virtual void setInitialSolution(double* initialSolution);
  /** \brief set a custom gurobi callback*/
  virtual GRBCallback *getGurobiCustomCallback(UpdateHistory* updateHistory);
};
